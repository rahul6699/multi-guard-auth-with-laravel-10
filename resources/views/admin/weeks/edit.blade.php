        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="update_weeks" method="post" onsubmit="weeks_update(this);return false;" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="image_name" onchange="upload_photo('update_weeks','.load1')" id="update_image">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <?php if(!empty($tInfo->image_name)){ ?>
                                                <img id="simage" class="preview_comman simage" src="<?php echo url('assets/uploads/weeks/',$tInfo->image_name); ?>" class="img-fluid">
                                            <?php }else{ ?>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.success == 0) {
                        ...
                        var surl = '<?php echo url('admin/weeks') ?>';
                        window.setTimeout(function() {
                            window.location = surl;
                        }, 500);
                    }
                    // $('#add_weeks .st_loader').hide();
                    $('.st_loader').hide();
                }
            });
        }
