        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body">
                    <form  id="add_task" method="post" onsubmit="task_save(this);return false;" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="hint_title" placeholder="Title">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Hint Description<sup class="text-danger">*</sup></label>
                                            <textarea class="form-control" name="hint_description" placeholder="Description"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="hint_image_name" onchange="upload_photo_hint('add_task','.load1')" id="update_image">
                                                    <input type="hidden" name="hint_image" id="file_id" value="">
